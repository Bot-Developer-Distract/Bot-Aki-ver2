    ...
    async def help(self, ctx, mdl = None):
        try:
            if mdl == None:
                ...
                em.add_field(name="_*Các lệnh có trên con bot*_", value=module)
                ...
                em.set_footer(text="Bot được tạo bởi John Week  ♌#8686(Dev GL)")
                em.set_author(name="John Week  ♌#8686(Dev GL)", icon_url="https://cdn.discordapp.com/avatars/852202202000578580/1f9b2b1b1b1b1b1b1b1b1b1b1b1b1b1b.webp?size=1024")
