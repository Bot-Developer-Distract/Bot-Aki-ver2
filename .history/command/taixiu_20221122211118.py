        ...
        try:
            ...
            if int(money) < int(arg2):
                ...
                try:
                    ...
                    dice = data_json['dice']
                    list_dice = ['<:taixiu1:994529097168461884>', '<:taixiu2:994529180307951627>', '<:taixiu3:994529252630335528>', '<:taixiu4:994529374940434503>', '<:taixiu5:994529461611540500>', '<:taixiu6:994529466112032791>']
...
@commands.command()
async def taixui(self, ctx: Context, ...):
    # Do something
    # ...
    
    setattr(ctx, 'taixiu_result', (True, 100))

@taixui.after_invoke
async def taixui_after(self, ctx: Context):
    # Hàm được gọi sau khi đã thực hiện xong lệnh taixiu
    
    is_won, amount = getattr(ctx, 'taixiu_result')

    print(f"{ctx.athor} đã {'thắng' if is_won else 'thua'} {amount} coins.")  