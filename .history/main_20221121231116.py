...
@bot.event
async def on_ready():
    await bot.change_presence(activity=bot.Game(name="a game"))
    print("Bot is ready!")
    await bot.change_presence(activity=bot.Activity(type=bot.ActivityType.watching, name="The Boys"))
    await bot.change_presence(activity=bot.Activity(type=bot.ActivityType.playing, name="Cool Name Pro")) 
    print("Bot is ready!")
#hàm chính chạy bot
#=============================================#
@bot.event
