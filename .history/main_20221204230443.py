...
async def status_task() -> None:
    ...
    await bot.change_presence(status=discord.Status.dnd, activity=discord.Game("với Hấp dẫn cùng WC ✍️ ⚡"))
    await asyncio.sleep(60)
    await bot.change_presence(activity=discord.Streaming(name="Official Server With Dedication 🥰", url="http://bit.ly/3AZkvoK"))
    await asyncio.sleep(60)
    await bot.change_presence(status=discord.Status.online, activity=discord.Activity(type=discord.ActivityType.listening, name="Đang chơi game mà <3 💁"))
    await asyncio.sleep(60)
    await bot.change_presence(status=discord.Status.idle, activity=discord.Activity(type=discord.ActivityType.watching, name="Hãy thử xài lệnh help 🪧 😳"))
